...
def edit_employee(api_request_context_customer_admin_upload) -> EmployeeItemModel:
    ...
    if employee_count_model.employee_role < 1:
...
def test_edit_employee_all_fields(
    ...
    employee_directory_page.filter_employee_by_email(edit_employee.email)
