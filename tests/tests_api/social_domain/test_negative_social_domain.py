...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param('www.windwyse.com', marks=pytest.mark.test_id('C31702')),
        pytest.param('www.techify.biz', marks=pytest.mark.test_id('C31703')),
        pytest.param('www.cyblogg.com', marks=pytest.mark.test_id('C31704')),
        pytest.param('www.schedulespal.com', marks=pytest.mark.test_id('C31705')),
        pytest.param('www.techcrunchweb.com', marks=pytest.mark.test_id('C31706')),
        pytest.param('www.snaky.live', marks=pytest.mark.test_id('C31707')),
        pytest.param('www.expresstoday.net', marks=pytest.mark.test_id('C31708')),
        pytest.param('www.gmailsecurity.net', marks=pytest.mark.test_id('C31709')),
        pytest.param('www.gov-info.org', marks=pytest.mark.test_id('C31710')),
    ],
)
