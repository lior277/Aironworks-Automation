...
class AppConfigs:
    ...
    EXAMPLE_EDUCATION_CONTENT_VIDEO = _env_config['example_education_content_video']
    EXAMPLE_EDUCATION_CONTENT_SLIDES = _env_config['example_education_content_slides']
    EXAMPLE_EDUCATION_CONTENT_PDF = _env_config['example_education_content_pdf']
    EXAMPLE_EDUCATION_CONTENT_QUIZ = _env_config['example_education_content_quiz']
    EXAMPLE_EDUCATION_CONTENT_SURVEY = _env_config['example_education_content_survey']
    ...
    SAMPLE_BIG_CAMPAIGN = _env_config['sample_big_campaign']
    ...
    ENCRYPTED_CUSTOMER_ADMIN_USERNAME = os.getenv('ENCRYPTED_CUSTOMER_ADMIN_USERNAME')
    ENCRYPTED_CUSTOMER_ADMIN_PASSWORD = os.getenv('ENCRYPTED_CUSTOMER_ADMIN_PASSWORD')
    ...
    CUSTOMER_ADMIN_UPLOAD_USERNAME = os.getenv('CUSTOMER_ADMIN_UPLOAD_USERNAME')
    CUSTOMER_ADMIN_UPLOAD_PASSWORD = os.getenv('CUSTOMER_ADMIN_UPLOAD_PASSWORD')
    CUSTOMER_ADMIN_EMAIL_FILTER_USERNAME = os.getenv(
        'CUSTOMER_ADMIN_EMAIL_FILTER_USERNAME'
    )
    CUSTOMER_ADMIN_EMAIL_FILTER_PASSWORD = os.getenv(
        'CUSTOMER_ADMIN_EMAIL_FILTER_PASSWORD'
    )
    ...
    ENCRYPTED_COMPANY_NAME = 'Company'
