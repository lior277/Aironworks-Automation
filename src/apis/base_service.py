...
class BaseService:
    ...
    def _post(self, url, data=None, params=None, timeout=None, multipart=None) -> APIResponse:
        response = self._request.post(url=url, data=data, params=params, timeout=timeout, multipart=multipart)
    ...
    def _patch(self, url, data=None, params=None, timeout=None, multipart=None) -> APIResponse:
        response = self._request.patch(url=url, data=data, params=params, timeout=timeout, multipart=multipart)
        allure_attach(response)
        return response

    def _delete(self, url, data=None, params=None, timeout=None) -> APIResponse:
        response = self._request.delete(url=url, data=data, params=params, timeout=timeout)
        allure_attach(response)
        return response
