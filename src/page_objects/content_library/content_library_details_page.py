...
from src.page_objects.content_library import quiz_attached_text, attach_quiz_text, content_successfully_updated_text
...
class ContentLibraryDetailsPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.edit_button = self.page.locator(selector="[data-testid='EditOutlinedIcon']")
        self.remove_quiz_button = self.page.get_by_text(text="Delete Quiz")
        self.create_education_campaign_button = self.page.get_by_text(text="Create Education Campaign")
        self.delete_button = self.page.get_by_text(text="Yes, Delete")

    @allure.step("ContentLibraryDetailsPage: open details page for {content_library_id} content library")
    ...
    def remove_quiz(self):
        ...
        expect(self.alert_message.first).to_contain_text(content_successfully_updated_text)
