...
class EducationCampaignEntity:
    def __init__(
        self,
        title: str = None,
        assignments_submission_rate: str = None,
        start_date: str = None,
        end_date: str = None,
    ...
    def __eq__(self, other):
        if isinstance(other, EducationCampaignEntity):
            return (
                ...
                and self.assignments_submission_rate
                == other.assignments_submission_rate
                and self.start_date == other.start_date
                and self.end_date == other.end_date
                and self.assignments_count == other.assignments_count
...
class EducationCampaignFactory:
    ...
    def get_education_campaign(
        ...
        return EducationCampaignEntity(
            title=education_campaign.title,
            ...
            company_name=education_campaign.company.name
            if education_campaign.company
            else None,
        )
