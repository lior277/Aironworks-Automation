...
from src.page_objects.education_campaign import confirm_deletion_body_text, education_campaign_deleted_text
...
class EducationCampaignDetailsPage(BasePage):
    ...
    def delete_campaign(self):
        ...
        expect(self.alert_message).to_contain_text(education_campaign_deleted_text)
